CARNIVAL.registerComponent('vrui.display.pic.picboard', function () {
    ...
    var PicBoard = function (params) {
        ...
        /* Might be worth having a standard mechanism for a component's preferred defaults eg shader / material */
        if (!params.draw) params.draw = {shaderLabel:'basic'};
    ...
    PicBoard.prototype.meta = {
        ...
        config: [
            ...
            {ident:'targetHeight', title:'Target height', type:'float'},
            {ident:'targetWidth', title:'Target width', type:'float'},
        ],
        input: [
